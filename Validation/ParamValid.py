...
for i in range(0,len(amery_runoff)):
    amery_fc[i,:] = F_param(amery_sigma,amery_hurst,amery_runoff[i])
    larsen_fc[i,:] = F_param(larsen_sigma,larsen_hurst,larsen_runoff[i])
...
for i in range(0,len(amery_runoff)):
    amery_ld[i,:] = wl_param(amery_sigma,amery_hurst,amery_runoff[i])
    larsen_ld[i,:] = wl_param(larsen_sigma,larsen_hurst,larsen_runoff[i])
...
fig.set_figwidth(17)
#Amery Lake Depth 
axs[0,0].plot(amery_obs_dates,amery_obs_ld,'ko')
axs[0,0].fill_between(amery_dates,amer_ld_5,amer_ld_95,color='lightcyan',alpha=1)
axs[0,0].fill_between(amery_dates,amer_ld_25,amer_ld_75,color='lightskyblue',alpha=1)
...
#Amery Area Fraction 
axs[0,1].fill_between(amery_dates,amer_fc_5,amer_fc_95,color='lightcyan',alpha=1)
axs[0,1].fill_between(amery_dates,amer_fc_25,amer_fc_75,color='lightskyblue',alpha=1)
axs[0,1].plot(amery_obs_dates,amery_obs_fc,'ko')
...
#Larsen Lake Depth 
axs[1,0].fill_between(larsen_dates,lar_ld_5,lar_ld_95,color='lightcyan',alpha=1)
axs[1,0].fill_between(larsen_dates,lar_ld_25,lar_ld_75,color='lightskyblue',alpha=1)
axs[1,0].plot(larsen_obs_dates,larsen_obs_ld,'ko')
...
axs[1,1].fill_between(larsen_dates,lar_fc_5,lar_fc_95,color='lightcyan',alpha=1)
axs[1,1].fill_between(larsen_dates,lar_fc_25,lar_fc_75,color='lightskyblue',alpha=1)
axs[1,1].plot(larsen_obs_dates,larsen_obs_fc,'ko')
