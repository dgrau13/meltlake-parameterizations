...
fig.set_figwidth(19)
#Amery Lake Depth 
axs[0,0].plot(amery_obs_dates,amery_obs_wl,'ko',label="Observations")
axs[0,0].fill_between(amery_dates,amer_wl_5,amer_wl_95,color='lightcyan',alpha=1,label="5th & 95th Percentile")
axs[0,0].fill_between(amery_dates,amer_wl_25,amer_wl_75,color='lightskyblue',alpha=1,label="25th & 75th Percentile")
axs2_00 = axs[0,0].twinx()
axs2_00.set_ylabel('Simulated Runoff (m)',color='r',fontsize=25)
axs2_00.plot(amery_dates,amery_wS,'r',label = 'RACMO Amery Runoff')
...
plt.legend(lines00 + lines00_2, labels00 + labels00_2,loc='upper left')
for label in axs[0,0].get_xticklabels(minor=True):
    label.set_horizontalalignment('right')

#Amery Area Fraction 
axs[0,1].fill_between(amery_dates,amer_F_5,amer_F_95,color='lightcyan',alpha=1,label="5th & 95th Percentile")
axs[0,1].fill_between(amery_dates,amer_F_25,amer_F_75,color='lightskyblue',alpha=1,label="25th & 75th Percentile")
axs[0,1].plot(amery_obs_dates,amery_obs_F,'ko',label="Observations")
axs2_01 = axs[0,1].twinx()
axs2_01.set_ylabel('Simulated Runoff (m)',color='r',fontsize=25)
axs2_01.plot(amery_dates,amery_wS,'r',label = 'RACMO Amery Runoff')
...
axs[0,1].set_title('B.',loc='left',fontweight='bold',fontsize=25)
...
plt.legend(lines01 + lines01_2, labels01 + labels01_2,loc='upper left')
...
#Larsen Lake Depth 
axs[1,0].fill_between(larsen_dates,lar_wl_5,lar_wl_95,color='lightcyan',alpha=1,label="5th & 95th Percentile")
axs[1,0].fill_between(larsen_dates,lar_wl_25,lar_wl_75,color='lightskyblue',alpha=1,label="25th & 75th Percentile")
axs[1,0].plot(larsen_obs_dates,larsen_obs_wl,'ko',label="Observations")
axs2_10 = axs[1,0].twinx()
axs2_10.set_ylabel('Simulated Runoff (m)',color='r',fontsize=25)
axs2_10.plot(larsen_dates,larsen_wS,'r',label = 'RACMO Larsen Runoff')
...
axs[1,0].set_title('C.',loc='left',fontweight='bold',fontsize=25)
...
plt.legend(lines10 + lines10_2, labels10 + labels10_2,loc='upper left')
for label in axs[1,0].get_xticklabels(minor=True):
    label.set_horizontalalignment('right')

#Larsen Area Fraction
axs[1,1].fill_between(larsen_dates,lar_F_5,lar_F_95,color='lightcyan',alpha=1,label="5th & 95th Percentile")
axs[1,1].fill_between(larsen_dates,lar_F_25,lar_F_75,color='lightskyblue',alpha=1,label="25th & 75th Percentile")
axs[1,1].plot(larsen_obs_dates,larsen_obs_F,'ko',label="Observations")

axs2_11 = axs[1,1].twinx()
axs2_11.set_ylabel('Simulated Runoff (m)',color='r',fontsize=25)
axs2_11.plot(larsen_dates,larsen_wS,'r',label = 'RACMO Larsen Runoff')
...
axs[1,1].set_title('D.',loc='left',fontweight='bold',fontsize=25)
...
plt.legend(lines11 + lines11_2, labels11 + labels11_2,loc='upper left')
